...
export const getTotalPrice = store => store.cart.cart.reduce((sum, cur)=>sum + cur.totalPrice,0)

export const getCart = store => store.cart.cart

export const getCurrentQuantity = id=> store => store.cart.cart.find(pizza=>pizza.pizzaId === id)?.quantity ?? 0